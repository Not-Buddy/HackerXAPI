...
run_test "payloads/aarogya2.json" "test 2 aarogya2"
run_test "payloads/splendor.json" "test 3 splendor"
run_test "payloads/medicare.json" "test 4 medicare"
run_test "payloads/medicare.json" "test 5 medicare2"
run_test "payloads/cons.json" "test 6 cons"
run_test "payloads/cons2.json" "test 7 cons2"
run_test "payloads/principia.json" "test 8 principanewton"
run_test "payloads/uni.json" "test 9 uni"
run_test "payloads/happy.json" "test 10 happy"
run_test "payloads/xl.json" "test 11 xl"
run_test "payloads/xl2.json" "test 12 xl2"
run_test "payloads/xl3.json" "test 13 xl3"
run_test "payloads/image.json" "test 14 image"
run_test "payloads/image2.json" "test 15 image2"
run_test "payloads/bomb.json" "test 16 bomb"
run_test "payloads/bin.json" "test 17 bin"
run_test "payloads/fact.json" "test 18 fact"
